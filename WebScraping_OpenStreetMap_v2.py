...
#    user = user.replace("__","") # Removendo o "__" do nome do usuário
#    old_path = os.path.join(DOWNLOADS, file_to_rename_gpx) # Montando o caminho absoluto da pasta download + arquivo
#    new_name = f"{file_to_rename_gpx.replace('.gpx', '')}__{user}__.gpx" # Montando o novo nome do arquivo. Forçando que o nome do usuário esteja sempre entre "__"
